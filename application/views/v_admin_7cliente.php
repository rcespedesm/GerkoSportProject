...
<div class="row">
	<div class="col-lg-9">
		...
		<div class="form-group input-group">
            ...
            <input id="buscar" type="search" class="search-input form-control" data-table="order-table" placeholder="Cliente"></div>
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
                                ...
                                <div class="form-group">
		                            ...
		                            <input type="number" class="form-control" placeholder="Ej. 8769456" name="nit" required>
                                </div>
                                <div class="form-group">
