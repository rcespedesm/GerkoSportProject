...
<div class="row">
	<div class="col-lg-9">
		...
		<div class="form-group input-group">
            ...
            <input id="buscar" type="search" class="search-input form-control" data-table="order-table" placeholder="Nombre del Usuario"></div>
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Ej. Maria" name="nom" required>
                                </div>
                                <div class="form-group">
									<label><strong>Apellidos</strong></span></label>
		                            <input type="text" class="form-control" placeholder="Ej. Rojas" name="ape" required>
                                </div>
                                <div class="form-group">
									<label><strong>Telefono</strong></span></label>
		                            <input type="number" class="form-control" placeholder="Ej. 4577226" name="tel" required>
                                </div>
                                <div class="form-group">
									<label><strong>Direccion</strong></span></label>
		                            <input type="text" class="form-control" placeholder="Ej. Av. Heroinas" name="dir" required>
                                </div>
                                <div class="form-group">
									<label><strong>Nombre de Usuario</strong></span></label>
		                            <input type="text" class="form-control" placeholder="Ej. mari034" name="log" required>
                                </div>
                                <div class="form-group">
									<label><strong>Contraseña</strong></span></label>
		                            <input type="password" class="form-control" placeholder="Minimo 8 caracteres" name="pas" required>
                                </div>
                                <div class="form-group">
