...
<div class="row">
	<div class="col-lg-9">
		<div class="form-group input-group col-lg-6">
            <input id="buscar" type="search" class="search-input form-control" data-table="order-table" placeholder="Materia Prima"></div>
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
                                ...
                                <div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Ej. Precio" name="pre" required>
                                </div>
                                <div class="form-group">
