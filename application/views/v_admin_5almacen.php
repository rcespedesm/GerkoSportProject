...
<div class="row">
	<div class="col-lg-9">
		<div class="form-group input-group col-lg-6">
            <input id="buscar" type="search" class="search-input form-control" data-table="order-table" placeholder="Almacen"></div>
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    <table class="table table-bordered table-responsive order-table" id="dataTables-example">
						...
						{
                                echo '<th class="success text-center">AGREGAR</th>';
                                echo '<th class="danger text-center">ELIMINAR</th>';
						} ?>
                            </tr>
                        </thead>
                        <tbody> 
						...
						<div class="panel panel-green">
							...
							<div class="panel-body">
                                ...
                                <div class="form-group">
		                            ...
		                            <input type="number" class="form-control" placeholder="Ej. Descripcion" id="desModificar" name="can" required>
                                </div>
                                <div class="form-group">
									<label><strong>Cantidad por Lote</strong></span></label>
		                            <input type="number" class="form-control" placeholder="Ej. Descripcion" id="desModificar" name="canl" required>
                                </div>
							</div>
						</div>
					</div>
