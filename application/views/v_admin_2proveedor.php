...
<div class="row">
	<div class="col-lg-9">
		<div class="form-group input-group col-lg-6">
            <input id="buscar" type="search" class="search-input form-control" data-table="order-table" placeholder="Proveedor"></div>
            <span class="input-group-btn">
		<?php
		if($this->session->userdata('menu') != 'v_menu_admin')
		{
            echo '<button type="button" data-toggle="modal" data-target="#AgregarNuevo" class="btn btn-primary btn-md"><i class="fa fa-plus"></i> Registrar Nuevo</button>';
		} ?>
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Ej. Nombre" name="nom" required>
                                </div>
                                <div class="form-group">
									<label><strong>Pais</strong></span></label>
		                            <input type="text" class="form-control" placeholder="Ej. Pais" name="pai" required>
                                </div>
                                <div class="form-group">
									<label><strong>Descripcion</strong></span></label>
		                            <input type="text" class="form-control" placeholder="Ej. Descripcion" name="des" required>
                                </div>
							</div>
						</div>
					</div>
